...
export class Context {
    ...
    private _id: string;
    public _dekkoIv: Uint8Array;
    public _dekkoKey: CryptoKey;

    /**
     * @param {Object} options
     */
    constructor(id: string, dekkoIv: Uint8Array, dekkoKey: CryptoKey) {
    ...
    private _makeIV(synchronizationSource: number, timestamp: number): void {
    ...
    public async encodeFunction(encodedFrame: IEncodedFrame, controller: ITransformStreamDefaultController): Promise<void> {
        ...
        let dekkoEncryptedData: ArrayBuffer;

        try {
            dekkoEncryptedData = await crypto.subtle.encrypt(
              {
